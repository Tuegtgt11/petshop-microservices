...
import com.tass.productservice.model.request.BrandRequest;
...
public class BrandService extends BaseService{
    ...
    public BaseResponseV2<Brand> createBrand(BrandRequest brandRequest) throws ApplicationException {
    ...
    public BaseResponseV2<Brand> updateBrand(BrandRequest brandRequest, Long id) throws ApplicationException {
        validateRequestCreateException(brandRequest);
    ...
    public BaseResponseV2<Optional<Brand>> findBrandById(Long id) throws ApplicationException {
